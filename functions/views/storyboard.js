...
export const HTML = [
  ...
  ".sb-card{border-radius:26px;padding:24px",
  ...
  ".sb-media{border-radius:22px;overflow:hidden;background:#0b0f22;border:1px solid #2d3560;box-shadow:inset 0 1px 0 rgba(255,255,255,.04)}",

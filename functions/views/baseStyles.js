...
.nav a{
  ...
  color:#cfd6f3; font-weight:600; font-size:13px;
...
@media (max-width: 1100px){
  .wrap{ width:min(94vw, var(--wrap-max)); }
}
@media (max-width: 640px){
  .wrap{ width:96vw; padding:0 12px; }
}

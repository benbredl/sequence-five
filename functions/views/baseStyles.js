...
:root{
  ...
  --shadow-soft:0 12px 34px rgba(0,0,0,.36), inset 0 1px 0 rgba(255,255,255,.04);
...
body{
  ...
  background:
    radial-gradient(1200px 800px at 95% -10%, rgba(139,92,246,.16), transparent 60%),
...
body::before{
  ...
  background-image:
    radial-gradient(2px 2px at 16% 30%, rgba(255,255,255,.22) 45%, transparent 46%),
    radial-gradient(1.2px 1.2px at 60% 70%, rgba(255,255,255,.15) 45%, transparent 46%),
    radial-gradient(1.2px 1.2px at 82% 20%, rgba(255,255,255,.12) 45%, transparent 46%),
    radial-gradient(1px 1px at 30% 85%, rgba(255,255,255,.10) 45%, transparent 46%);
  animation: drift 60s linear infinite; opacity:.22; pointer-events:none;
}
...
.nav a.active{
  background:linear-gradient(180deg, rgba(139,92,246,.20), rgba(34,211,238,.10));
  border-color:#343d66; color:#ffffff; box-shadow:0 12px 30px rgba(124,58,237,.18)
}
.nav .sep{height:1px;background:#262c44;margin:12px 6px}

/* Main column uses flex so footer sits at the end, while page fills viewport */
.main{min-height:100vh;display:flex;flex-direction:column}
.wrap{max-width:1280px;margin:28px auto 40px;padding:0 22px}

/* Simple top header row (B2) */
...
/* Hover overlay + fullscreen controls */
...
/* Fullscreen viewer bigger buttons */
...
/* Dropzone (generator) */
.drop{position:relative;border:1px dashed #2a3354;border-radius:18px;overflow:hidden;min-height:240px;background:linear-gradient(180deg,#0b0f22,#0a0e1e)}
...
.drop .circle{width:54px;height:54px;border-radius:50%;display:flex;align-items:center;justify-content:center;background:linear-gradient(180deg,rgba(255,255,255,.10),rgba(255,255,255,.04));border:1px solid #2f375a;box-shadow:inset 0 1px 0 rgba(255,255,255,.04)}
...
/* ========= Generator results ========= */
.result-card{background:linear-gradient(180deg, rgba(255,255,255,.055), rgba(255,255,255,.025));border:1px solid var(--line);border-radius:16px;overflow:hidden;box-shadow:var(--shadow-soft);margin-bottom:12px}
...
.spinner-lg{width:36px;height:36px;border-radius:50%;border:3px solid rgba(255,255,255,.25);border-top-color:#a78bfa;animation:spin .9s linear infinite}

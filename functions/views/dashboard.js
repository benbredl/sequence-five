...
const INLINE_LOGO = `
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" fill="#fff" xmlns:v="https://vecta.io/nano" aria-label="Sequence Five Logo" role="img" style="width:22px;height:22px;display:block">
...
export const HTML = [
  ...
  BASE_STYLES,
  `
  body{ font-family:'Open Sans', InterVar, Inter, ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial !important; }

  /* Consistent transparent cards */
  .kpi,.card{
  ...
  /* Make calendar icon white (WebKit) */
  .range-row .date-field input[type="date"]::-webkit-calendar-picker-indicator{
    filter: invert(1) brightness(1.2) !important;
    opacity: 0.95 !important;
  }
  /* Dark form controls (Firefox) */
  .date-field input[type="date"]{ color-scheme: dark; }

  /* Preset "pills" — match nav look, subtle active */
  ...
  .range-presets .pill.active{
    ...
    border-color:#343d66; /* subtle; no glow */
    color:#ffffff;
  }
